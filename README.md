...
```bash
git clone https://github.com/eddy-mark/AirBnB_clone.git
```
...
(hbnb) update User 1afa163d-486e-467a-8d38-3040afeaa1a1 email "edwardnguimeya@yahoo.com"
...
## Authors
<details>
    <summary>Eddy-mark</summary>
    <summary>Tobikiller</summary>
